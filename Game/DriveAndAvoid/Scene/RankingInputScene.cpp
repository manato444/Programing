...
RankingInputScene::RankingInputScene() : background_image(NULL), ranking(nullptr),
...
void RankingInputScene::Draw() const
{
	...
	if (cursor_y < 4)
	{
		...
		DrawBox(x, y, x + font_size, y + font_size, GetColor(255, 255, 225), FALSE);
	}
	else
	{
		if (cursor_x == 0)
		...
		{
			DrawBox(40 * 2, 400, 35 + font_size * 4,  400 + font_size, GetColor(255, 255, 255), FALSE);
